//Custom sample provider largely based on the AudioFileReader class from Naudio custom compression functionality added
...
namespace Playback.NaudioCustom
{
    public class CompressionReader : WaveStream, ISampleProvider
    {
        ...
        private readonly Compressor drcompressor;
        private readonly int destBytesPerSample;
        private readonly int sourceBytesPerSample;
        private readonly long length;
        private readonly object lockObject;
        public CompressionReader(string fileName){
            drcompressor = new Compressor();//create instance and set properties for dynamic range compressor
            drcompressor.Threshold = 16.0f;
            drcompressor.Ratio = 1.3f; // may add controls for this and threshold at a later date
